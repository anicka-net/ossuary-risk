...
**Version**: 6.4 (May 2026; full re-collect and revalidation June 2026)
**Dataset**: 177 packages across 8 ecosystems
...
| T3: Weak-gov compromise | 7/8 | **88%** | 1 miss: telnyx (T3 near-miss at score 55, org backing softens score) |
...
**Combined in-scope (Scope B)**: 28/36 = 77.8% recall.
...
for the live breakdown. Headline totals (v6.4): **177 packages
(57 incidents + 120 controls)** across the 8 supported ecosystems.
...
|--------|---------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|
| Packages | 92 | 143 | 158 | 164 | 167 | 170 | 177 |
| Ecosystems | 2 | 8 | 8 | 8 | 8 | 8 | 8 |
| Scope | All | All | All | Scope B | Scope B | Scope B | Scope B |
| Accuracy | 92.4% | 91.6% | 89.2% | 94.7% | 94.7% | 94.1% | 93.6% |
| Precision | 100% | 100% | 95.8% | 96.0% | 96.0% | 96.0% | 93.3% |
| Recall | 65.0% | 58.6% | 59.0% | 77.4% | 77.4% | 75.0% | 77.8% |
| F1 | 0.79 | 0.74 | 0.73 | 0.857 | 0.857 | 0.842 | 0.848 |
| False Positives | 0 | 0 | 1 | 1 | 1 | 1 | 2 |
...
incidents. Four new in-scope cases all scored as TPs: `jest-canvas-mock`
...
(collector version bump) and the full n=177 dataset was re-collected
and re-scored from scratch.

**Result: the Scope B confusion matrix reproduced exactly** (TP=28,
FP=2, TN=118, FN=8 — same packages, same FP/FN lists), which is
...
approximately **57 incidents**. Our dataset contains **57 of these** (with the
v6.3 TeamPCP extension and the v6.4 May 2026 sweep closing the contemporary
cohort). A small handful of
...
57 times in the observable history of package ecosystems (2003–2026). No
amount of additional data collection will substantially increase n.

This explains why:
- **ML cannot beat hand-tuning**: n≈57 incidents is too few to learn nonlinear
...
- **Per-tier rates have limited statistical power**: T3 at 7/8 (88%) is
...
*Dataset: 177 packages (57 incidents, 120 controls) across 8 ecosystems*
