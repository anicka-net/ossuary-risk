...
for the live breakdown. Headline totals (v6.4): **170 defined cases
(50 incidents + 120 controls)** across the 8 supported ecosystems;
**169 evaluated** (ultralytics returns INSUFFICIENT_DATA).
...
Out-of-scope incidents (17 packages: 11 T4 + 6 T5) excluded from this matrix. One package (ultralytics, T5) returns INSUFFICIENT_DATA and is excluded entirely. They appear in the full-dataset metrics but not the scoped metrics.
...
| Precision | 100% | 100% | 95.8% | 96.0% | 96.0% | 96.0% | 92.3% |
| Recall | 65.0% | 58.6% | 59.0% | 77.4% | 77.4% | 75.0% | 75.0% |
| F1 | 0.79 | 0.74 | 0.73 | 0.857 | 0.857 | 0.842 | 0.828 |
